...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/verification/captcha", middleware.CriticalRateLimit(), controller.GetEmailVerificationCaptcha)
		...
		apiRouter.POST("/feedback", middleware.UserAuth(), middleware.CriticalRateLimit(), controller.CreateFeedback)
		apiRouter.GET("/feedback", middleware.AdminAuth(), controller.GetAllFeedbacks)
		...
		downloadRoute := apiRouter.Group("/downloads")
		downloadRoute.Use(middleware.UserAuth())
		{
			downloadRoute.GET("/cc-switch/manifest", controller.GetCCSwitchMirrorManifest)
			downloadRoute.POST("/cc-switch/:platform/:asset_id/ticket", controller.CreateCCSwitchMirrorDownloadTicket)
			downloadRoute.GET("/cc-switch/:platform/:asset_id", controller.DownloadCCSwitchMirrorAsset)
		}
		apiRouter.GET("/downloads/cc-switch/:platform/:asset_id/file", controller.DownloadCCSwitchMirrorAssetWithTicket)
