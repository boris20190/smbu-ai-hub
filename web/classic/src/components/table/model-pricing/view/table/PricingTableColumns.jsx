...
import {
  ...
  getMarketplacePricingGroup,
} from '../../group-display';

function renderQuotaType(t) {
  return (
    <Tag color='violet' shape='circle'>
      {getMarketplaceBillingLabel(t)}
    </Tag>
  );
}
  ...
  const getPriceData = (record) => {
    ...
    if (!cache) {
      cache = calculateModelPrice({
        record,
        selectedGroup: getMarketplacePricingGroup(record, selectedGroup),
        groupRatio,
        tokenUnit,
        displayPrice,
        currency,
