...
const TopUp = () => {
  ...
  const normalizeMinTopUp = (value, fallback = 1) => {
    ...
    try {
      ...
      if (success) {
        ...
        try {
          ...
          const statusMinTopUp = statusState?.status?.min_topup || 1;
          const minTopUpValue = enableOnlineTopUp
            ? normalizeMinTopUp(data.min_topup, statusMinTopUp)
            : enableStripeTopUp
              ? normalizeMinTopUp(data.stripe_min_topup, statusMinTopUp)
              : enableWaffoTopUp
                ? normalizeMinTopUp(data.waffo_min_topup, statusMinTopUp)
                : enableWaffoPancakeTopUp
                  ? normalizeMinTopUp(
                      data.waffo_pancake_min_topup,
                      statusMinTopUp,
                    )
                  : normalizeMinTopUp(statusMinTopUp);
            ...
            (enableStripeTopUp
              ...
              : enableWaffoTopUp
                ...
                : enableWaffoPancakeTopUp
                  ...
                  : '');
          if (initialPayment) {
            requestAmountByPayment(initialPayment, minTopUpValue);
          }
        } catch (e) {
          setPayMethods([]);
        }
