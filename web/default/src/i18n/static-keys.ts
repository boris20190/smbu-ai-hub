...
export const STATIC_I18N_KEYS = [
  ...
  'Buy Redemption Code',
  'Quota Redemption',
  'Redeem a code to add quota to your account balance.',
  ...
  'Download guide area',
  'Download Guide Area',
  'Client download links for common platforms.',
  'Client download links for common platforms',
  'Desktop client official website.',
  'Desktop client official website',
  'Android client official website.',
  'Android client official website',
  'iOS client with OpenAI-compatible custom providers.',
  'iOS client with OpenAI-compatible custom providers',
  'Coding',
  'Coding tools and VS Code extension links.',
  'Coding tools and VS Code extension links',
  ...
  // Feedback page
  'Submit platform feedback. Administrators can review it.',
  'Submit feedback',
  'Tell us about issues, requests, or suggestions.',
  'Feedback title',
  'Briefly describe the feedback',
  'Feedback content',
  'Describe the issue, request, or suggestion',
  'Please avoid sharing API keys or passwords.',
  'Contact information',
  'Optional contact details',
  'Feedback title must be 2-80 characters.',
  'Feedback content must be 5-2000 characters.',
  'Contact information must be within 120 characters.',
  'Feedback submitted',
  'Feedback submission failed',
  'Failed to load feedback',
  'Feedback inbox',
  'Feedback submitted by all users.',
  'Submitted at',
  'No feedback yet',
  'Submitted feedback will appear here.',

  // Coding downloads page
  'Coding Downloads',
  'Download coding clients and open editor extensions from one place.',
  'Mirrored installers from this server.',
  'Loading',
  'Not mirrored yet',
  'Downloading...',
  'Download failed',
  'Mirrored at',
  'VS Code extensions',
  'Open Marketplace pages and install inside VS Code.',

  // Built-in docs page
  'Built-in usage guide for students and API clients.',
  'SMBU-LLM Usage Guide',
  'Use this guide to configure API clients, manage keys, and troubleshoot common request issues.',
  'OpenAI-compatible base URL',
  'Quick start',
  'Create an API key',
  'Open API Keys from the sidebar and create a token for your client.',
  'Configure the base URL',
  'Use the in-site base URL below in any OpenAI-compatible client.',
  'Send requests with Bearer authorization',
  'Put your key in the Authorization header and keep it private.',
  'Review usage logs',
  'Use Usage Logs to confirm request status, model routing, and errors.',
  'Client configuration',
  'Base URL',
  'Authorization header',
  'Content type',
  'Most OpenAI-compatible SDKs only need the base URL and API key. Keep each key scoped to its owner and rotate it when it may have leaked.',
  'Common entries',
  'Create and manage keys used by SDKs, scripts, and tools.',
  'Check balance and recharge before running paid requests.',
  'Inspect common request logs and troubleshoot failures.',
  'Test prompts and models in the browser before coding.',
  'Frequently asked questions',
  'What should I use as the API base URL?',
  'Use the base URL shown on this page. It follows the current site origin and ends with /v1.',
  'What if a request returns 401 or 403?',
  'Check that the API key is valid, enabled, and sent as a Bearer token.',
  'What if my balance is insufficient?',
  'Open Wallet to review your remaining balance and recharge if needed.',
  'What if a model is unavailable?',
  'Check Usage Logs for the exact error, then try another available model or contact an administrator.',
  'Before you run',
  'Confirm your wallet balance is sufficient.',
  'Use a dedicated API key for each application.',
  'Check Usage Logs when a request behaves unexpectedly.',
  'Do not share API keys in screenshots, chat messages, or public repositories.',
