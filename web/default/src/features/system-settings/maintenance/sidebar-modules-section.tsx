...
export function SidebarModulesSection({
  ...
  const sectionMeta: Record<string, { title: string; description: string }> = {
    ...
    downloads: {
      title: t('Download guide area'),
      description: t('Client download links for common platforms.'),
    },
    personal: {
  ...
  > = {
    ...
    console: {
      ...
      docs: {
        title: t('Docs'),
        description: t('Built-in usage guide for students and API clients.'),
      },
    },
    downloads: {
      cherryStudio: {
        title: 'Cherry Studio',
        description: t('Desktop client official website.'),
      },
      rikkahub: {
        title: 'RikkaHub (Android)',
        description: t('Android client official website.'),
      },
      geeps: {
        title: 'Geeps (iOS)',
        description: t('iOS client with OpenAI-compatible custom providers.'),
      },
      coding: {
        title: t('Coding'),
        description: t('Coding tools and VS Code extension links.'),
      },
    },
    personal: {
      topup: {
