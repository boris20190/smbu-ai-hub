  ...
  return (
    <header className='pb-4'>
      ...
      <div className='mt-1 flex flex-wrap items-center gap-1.5 text-xs'>
        ...
        <span className='text-muted-foreground/70'>{t('Token-based')}</span>
    ...
    <div className='text-muted-foreground mb-3 flex flex-wrap items-center gap-1 text-xs'>
      ...
      {autoChain.map((g, idx) => (
        <span key={g} className='flex items-center gap-1'>
          <GroupBadge
            group={getMarketplaceDisplayGroup(g, props.model.model_name)}
            label={getMarketplaceGroupLabel(g, t, props.model.model_name)}
            size='sm'
          />
            ...
            return (
              <div key={group} className='overflow-hidden rounded-lg border'>
                <div className='bg-muted/20 flex items-center justify-between gap-3 border-b px-3 py-2'>
                  <GroupBadge
                    group={getMarketplaceDisplayGroup(
                      group,
                      props.model.model_name
                    )}
                    label={getMarketplaceGroupLabel(
                      group,
                      t,
                      props.model.model_name
                    )}
