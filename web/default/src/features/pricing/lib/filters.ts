...
import { marketplaceGroupMatchesModel } from './group-display'
...
export function filterByGroup(
  ...
  return models.filter((m) => marketplaceGroupMatchesModel(m, group))
}
...
export function filterByQuotaType(
  ...
  if (quotaType === QUOTA_TYPES.TOKEN) return models
  return models
}
