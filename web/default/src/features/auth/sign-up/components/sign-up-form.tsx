        ...
        {emailVerificationRequired && (
          <>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder={t('Enter SMBU campus email address')}
                      type='email'
                      {...field}
                    />
                  </FormControl>
            ...
            <div className='grid gap-2'>
              <Label htmlFor='email-verification-captcha'>
                {t('Manual captcha')}
              </Label>
              <div className='grid gap-2 sm:grid-cols-[minmax(0,1fr)_auto]'>
                <div className='flex min-h-12 items-center overflow-hidden rounded-md border bg-muted/30'>
