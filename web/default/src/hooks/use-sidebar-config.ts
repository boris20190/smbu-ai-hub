 ...
 */
const FIXED_VISIBLE_URLS = new Set(['/dashboard', '/dashboard/overview'])
...
const URL_TO_CONFIG_MAP: Record<string, { section: string; module: string }> = {
  ...
  [DOWNLOAD_GUIDE_LINKS.cherryStudio]: {
    section: 'downloads',
    module: 'cherryStudio',
  },
  [DOWNLOAD_GUIDE_LINKS.rikkahub]: {
    section: 'downloads',
    module: 'rikkahub',
  },
  [DOWNLOAD_GUIDE_LINKS.geeps]: { section: 'downloads', module: 'geeps' },
  '/downloads/coding': { section: 'downloads', module: 'coding' },
