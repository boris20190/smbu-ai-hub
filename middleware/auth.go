...
func TokenAuth() func(c *gin.Context) {
	return func(c *gin.Context) {
		...
		userGroup := common.NormalizeTokenGroupOrDefault(userCache.Group)
		common.SetContextKey(c, constant.ContextKeyUserGroup, userGroup)
		tokenGroup := common.NormalizeTokenGroup(token.Group)
		if tokenGroup != "" {
...
func SetupContextForToken(c *gin.Context, token *model.Token, parts ...string) error {
	...
	common.SetContextKey(c, constant.ContextKeyTokenGroup, common.NormalizeTokenGroup(token.Group))
